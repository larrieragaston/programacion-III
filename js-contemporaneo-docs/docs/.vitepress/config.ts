...
function faviconIcoRedirectToSvg(): Plugin {
  return {
    name: 'js-contemporaneo-docs-favicon-ico',
...
export default defineConfig({
  lang: 'es-AR',
  title: 'JS Contemporáneo',
  description:
    'Apunte teórico y guía de ejercicios de JS Contemporáneo — Programación III, INSPT.',
  base,
  head: [
