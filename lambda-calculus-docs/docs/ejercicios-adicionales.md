...
2. ¿Cuáles de las siguientes representan expresiones-λ correctas según las convenciones sintácticas? ¿Cuáles no? En caso de responder negativamente, explicar porque; en caso de responder afirmativamente, indicar a qué expresión-λ - corresponde.
   - (λx.x)
   - (λxx)
   - λx.x
   - λx.xy
...
9. Determinar cuáles de las siguientes ecuaciones son ciertas. Justificar cada respuesta.
   - and T F = F
   - iscero 3 = F
   - bic T T = T
   - imp T F = F
