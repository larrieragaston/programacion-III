...
MODULES=("introduction" "lambda-calculus" "fp-backus" "clojure" "git-github" "js-funcional" "js-contemporaneo" "asincronismo")
PORTS=("3031" "3032" "3033" "3034" "3035" "3036" "3037" "3038")
...
npx concurrently --names "$(IFS=,; echo "${NAMES[*]}")" --prefix-colors "blue,green,yellow,cyan,magenta,white,red,gray" --kill-others "${COMMANDS[@]}"
